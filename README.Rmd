...
and their switches in the RNA-Seq datasets. It can calculate;

* Remove redundant transcripts that has the same protein sequences, and merges their transcript counts.
* Most dominant transcripts in RNA-Seq data with flexible cutoffs (e.g user-defined transcript expression cutoff and enrichment cutoff)
